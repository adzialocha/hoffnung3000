export default {
  ...
  sidebar: {
    ...
    defaultHeader: 'Welcome to Antiuniversity Festival 2022!',
    ...
    signUpHeader: 'We invite all educators, activists, artists, theoreticians, performers, musicians, hackers and everyone else to organise events. Please register or login below to create an event using this website. (if you just want to attend an event at the festival you don\'t need to register).',
